...
$(document).ready(function(){
	...
	if(  $('#owl-slider-thumbnails').length  ){
		...
		var sizeImg = $('#owl-slider-thumbnails .owl-item:first').find("img").attr('data-size');
	...
	$('#owl-slider-thumbnails .owl-item').click(function(){
		...
		$('.product_card__gallery .big-product a').attr( 'href', fullpicUrl).attr('data-size', sizeImg);
	});
	...
	initPhotoSwipeFromDOM('.big-product');
